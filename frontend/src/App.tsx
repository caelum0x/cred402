...
const TABS = ["Agents", "RWA Jobs", "Receipts", "Credit Pool", "Marketplace", "Disputes", "Governance", "Multichain", "RealFi"] as const;
    ...
    <div className="app">
      ...
      <main className="layout">
        <section className="content">
          ...
          {snapshot && tab === "Disputes" && <Disputes snapshot={snapshot} />}
